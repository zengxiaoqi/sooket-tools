...
public class HttpServletRequestWrapper extends javax.servlet.http.HttpServletRequestWrapper {
    ...
    private void parseRequest() throws IOException {
        ...
        Map<String, List<String>> query = HTTPRequestUtils.getInstance().getQueryParams(req);
        if (query != null) {
    ...
    private boolean shouldBufferBody() {
        ...
        if (LOG.isDebugEnabled()) {
            ...
            LOG.debug("Transfer-Encoding = " + String.valueOf(req.getHeader("transfer-encoding")));
            LOG.debug("Content-Encoding = " + String.valueOf(req.getHeader("Content-Encoding")));
